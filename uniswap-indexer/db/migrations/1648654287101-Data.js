module.exports = class Data1648654287101 {
  name = 'Data1648654287101'

  async up(db) {
    await db.query(`CREATE TABLE "uniswap_lp_token" ("id" character varying NOT NULL, "symbol" text, "decimals" numeric, "name" text, CONSTRAINT "PK_b81441af399f7087cfb94f58df0" PRIMARY KEY ("id"))`)
