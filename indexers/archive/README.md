...
aws --endpoint-url=http://localhost:4566 logs tail /aws/lambda/token-contracts-indexer-local-worker
aws --endpoint-url=http://localhost:4566 logs tail /aws/lambda/token-contracts-indexer-local-producer
```
