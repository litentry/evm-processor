...
schemaComposer.Query.addFields({
  erc20EventById: ERC20EventDecodedTC.mongooseResolvers.findById(filter),
  erc20Events: ERC20EventDecodedTC.mongooseResolvers.findMany(filter),
  erc721EventById: ERC721EventDecodedTC.mongooseResolvers.findById(filter),
  erc721Events: ERC721EventDecodedTC.mongooseResolvers.findMany(filter),
  erc1155EventById: ERC1155EventDecodedTC.mongooseResolvers.findById(filter),
