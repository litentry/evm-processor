module.exports = class Data1648817407489 {
  ...
  async up(db) {
    await db.query(`CREATE TABLE "uniswap_lp_token" ("id" character varying NOT NULL, "symbol" text NOT NULL, "decimals" numeric, "name" text NOT NULL, CONSTRAINT "PK_b81441af399f7087cfb94f58df0" PRIMARY KEY ("id"))`)
    await db.query(`CREATE TABLE "uniswap_lp_swap" ("id" character varying NOT NULL, "account" text NOT NULL, "contract" text NOT NULL, "pair" text NOT NULL, "pair_symbol" text NOT NULL, "intermediate_path" text, "deadline" numeric NOT NULL, "token0_amount" numeric NOT NULL, "token1_amount" numeric NOT NULL, "method" character varying(24) NOT NULL, "gas" numeric NOT NULL, "block_number" numeric NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "token0_id" character varying NOT NULL, "token1_id" character varying NOT NULL, CONSTRAINT "PK_aa9cb83825d2e7d5785370c1436" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE INDEX "IDX_9111746f5370ef555a5b65c8a3" ON "uniswap_lp_swap" ("pair_symbol") `)
